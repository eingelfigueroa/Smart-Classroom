                ...
                if (c % timeF == 0):
                    ...
                    if nrof_faces > 0:
                        ...
                        for i in range(nrof_faces):
                            ...
                            print("Best Probabilities: ",best_class_probabilities)
                            ...
                            for H_i in HumanNames:
                                ...
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    cv2.imwrite(os.path.join(path, result_names + "_" + timestr + '.png'), orig)
                                    save_image.insertImage()
